...
<div class=" mange add_drug">
	<h2>Welcome to the manager login page</h2><h2><a href="../../login.php" style="text-decoration:none;">Back to the main registration page</a></h2>
<form action="mange_direct_insert.php" method="post">
<table>
