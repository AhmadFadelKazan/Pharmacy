...
<meta name="viewport" content="width=device-width, initial-scale=1" >
	<title> عرض معلومات الادمن  </title>
...
echo"<td class='active'> <a href='admi_edit.php?id=$row[id]'> Edit information</a></td>";
echo"<td class='active'> <a href='admi_delete.php?id=$row[id]'>Delete information</a></td>";
echo'</tr>';
}
echo'</table>';
mysqli_close($con);
